...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    return (
        <div
            ...
            className="cursor-pointer flex w-full flex-col 
                py-4
                overflow-hidden rounded-l border hover:bg-light-purple transition duration-300 border-gray-300 bg-white"
        >
            ...
            <div className="mt-4 px-5 space-y-2 text-primary">
